...
const TransfersPage: React.FC = () => {
    ...
    const ALL_COLUMNS: any[] = [
        ...
        { ...makeHeader('bookingType'), dataIndex:'bookingType', key:'bookingType', width:colWidths.bookingType,
        ...
        { ...makeHeader('bookedBy'), dataIndex:'bookedByName', key:'bookedBy', width:colWidths.bookedBy,
