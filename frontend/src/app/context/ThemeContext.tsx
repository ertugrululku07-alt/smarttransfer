  ...
  const theme: SiteTheme = useMemo(() => {
    if (themeKey === 'custom' && customThemeData) {
      return {
        ...
        heroTitle: customThemeData.heroTitle !== undefined && customThemeData.heroTitle !== null ? customThemeData.heroTitle : baseTheme.heroTitle,
        heroSubtitle: customThemeData.heroSubtitle !== undefined && customThemeData.heroSubtitle !== null ? customThemeData.heroSubtitle : baseTheme.heroSubtitle,
