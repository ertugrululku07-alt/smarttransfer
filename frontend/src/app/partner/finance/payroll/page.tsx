...
import { UserOutlined, CheckCircleOutlined, PlusOutlined, DeleteOutlined, DownloadOutlined, FileExcelOutlined } from '@ant-design/icons';
      ...
      <Card title={<span><UserOutlined style={{ marginRight: 8, color: 'var(--brand-primary)' }} /> Hakediş & Maaş</span>} size="small"
        extra={
          <Space>
            ...
            <Button icon={<FileExcelOutlined style={{ color: '#16a34a' }} />} onClick={() => exportResourceXlsx('payroll', 'hakedis-maas')}>Excel</Button>
